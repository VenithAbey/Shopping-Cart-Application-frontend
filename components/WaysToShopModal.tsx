          ...
          <div className="p-8">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-bold text-gray-900 mb-2">1. Browse & Search</h3>
                <p className="text-sm text-gray-500">Explore thousands of fresh products or use our search bar to find exactly what you need instantly.</p>
              </div>

              <div className="flex flex-col items-center text-center group">
                <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <MousePointerClick className="w-8 h-8 text-red-600" />
                </div>
                <h3 className="font-bold text-gray-900 mb-2">2. Add to Cart</h3>
                <p className="text-sm text-gray-500">Click the red cart button on any item. We automatically calculate your taxes and subtotal in real-time.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-bold text-gray-900 mb-2">3. Relax & Receive</h3>
                <p className="text-sm text-gray-500">Set your delivery location at the top and check out securely. We will deliver it straight to your door!</p>
              </div>
            </div>

                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-2 py-1 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded text-sm"
                      >
                        −
                      </button>
                      <input
            ...
            <div>
              <Card className="bg-white border-gray-200 p-6 sticky top-20">
                ...
                <Link href="/checkout" className="block">
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 mb-3">
                    Proceed to Checkout
                  </Button>
                </Link>

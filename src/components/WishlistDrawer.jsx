              ...
              <div key={item.id} className="flex gap-4 bg-white border border-gray-100 p-3 rounded-xl shadow-sm relative">
                ...
                <div className="flex flex-col flex-1 min-w-0 py-1">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <button onClick={() => removeItem(String(item.id))} className="text-xs text-red-500 font-medium hover:underline">Remove</button>
                    <button
                      onClick={() => addItem(String(item.id), item.name, item.price, item.imageUrl || '', 1)}

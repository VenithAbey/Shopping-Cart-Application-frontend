        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              By cutting out the middlemen, we ensure that the apples, milk, and breads you buy are significantly fresher
              than what sits on traditional supermarket shelves.
            </p>
            <div className="flex gap-4">
              <div className="p-4 bg-red-50 rounded-xl">
                <h3 className="font-bold text-red-600 text-xl">100k+</h3>
                <p className="text-sm text-gray-600 font-medium">Daily Orders</p>
              </div>
              <div className="p-4 bg-green-50 rounded-xl">
                <h3 className="font-bold text-green-600 text-xl">50+</h3>
                <p className="text-sm text-gray-600 font-medium">Local Farms</p>
              </div>
            </div>
          </div>
        </div>
